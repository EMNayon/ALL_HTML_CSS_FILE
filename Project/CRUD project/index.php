...
if('delete' == $task){
    ...
    if($id>0){
        deleteStudent($id);
        header('location: /Test/CRUD Project/index.php?task=report');
    }
}
...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="column column-60 column-offset-20">
                <form action="/Test/CRUD Project/index.php?task=add" method="POST">
    ...
    <script type="text/javascript" src="assests/script.js"></script>
</body>
</html>